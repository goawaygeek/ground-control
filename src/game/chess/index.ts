...
export class ChessGame implements GameModule {
  ...
  getInstructions(): string {
    return [
      ...
      `  2. List the legal moves available to the human, verbatim from get_board.`,
      `  3. Offer a NUMBERED list of 2-3 candidate moves, each with a one-line reason (e.g. "1. O-O (castle kingside) — get the king to safety").`,
      `  4. RECOMMEND one of them and say why in a sentence.`,
      `  5. Ask the human what they want to play. Then, and only then, call make_move with their choice.`,
